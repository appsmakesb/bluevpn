...
public class SplashActivity extends AppCompatActivity {
    ...
    private static final String BANNER_AD = BuildConfig.BANNER_AD;
    private static final String INTER_AD = BuildConfig.INIT_AD;
    private static final String NATIVE_AD = BuildConfig.NATIVE_AD;
    private static final String AppOpenAd = BuildConfig.AppOpenAd;
    ...
    private void getApiData() {
        ...
        AdsUtility.admobAppOpenId = AppOpenAd;
        AdsUtility.admobBannerId = BANNER_AD;
        AdsUtility.admobInterstitialId = INTER_AD;
        AdsUtility.admobNativeId = NATIVE_AD;
